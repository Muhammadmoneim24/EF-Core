...
namespace EFCoreCodefirst.Data.Config
{
    public class SectionConfiguration : IEntityTypeConfiguration<Section>
    {
        public void Configure(EntityTypeBuilder<Section> builder)
        {
            ...
            builder.Property(e => e.SectionName).HasColumnType("VARCHAR").HasMaxLength(50).IsRequired();

            builder.HasOne(e => e.Course).WithMany(e => e.Sections).HasForeignKey(e => e.CourseId).IsRequired();

            builder.HasOne(e=>e.Instructor).WithMany(e=>e.sections).HasForeignKey(e => e.InstructorId).IsRequired(false);

            builder.HasMany(e => e.Schedules).WithMany(e => e.Sections).UsingEntity<SectionSchedule>();

            builder.HasMany(e=>e.Students).WithMany(e => e.Sections).UsingEntity<Enrollments>();
