        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, false, false, true, true, true, true, "DayAfterDAy", false },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, new TimeSpan(0, 11, 0, 0, 0), 4, 3, new TimeSpan(0, 9, 0, 0, 0) },
                    { 4, new TimeSpan(0, 15, 0, 0, 0), 1, 4, new TimeSpan(0, 10, 0, 0, 0) },
                    { 5, new TimeSpan(0, 12, 0, 0, 0), 1, 5, new TimeSpan(0, 10, 0, 0, 0) },
                    { 6, new TimeSpan(0, 18, 0, 0, 0), 2, 6, new TimeSpan(0, 16, 0, 0, 0) },
                    { 7, new TimeSpan(0, 10, 0, 0, 0), 3, 7, new TimeSpan(0, 8, 0, 0, 0) },
                    { 8, new TimeSpan(0, 14, 0, 0, 0), 4, 8, new TimeSpan(0, 11, 0, 0, 0) },
                    { 9, new TimeSpan(0, 14, 0, 0, 0), 4, 9, new TimeSpan(0, 10, 0, 0, 0) },
                    { 10, new TimeSpan(0, 18, 0, 0, 0), 3, 10, new TimeSpan(0, 16, 0, 0, 0) },
                    { 11, new TimeSpan(0, 15, 0, 0, 0), 5, 11, new TimeSpan(0, 12, 0, 0, 0) }
                });
